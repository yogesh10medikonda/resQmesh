...
android.permissions = BLUETOOTH,BLUETOOTH_ADMIN,BLUETOOTH_CONNECT,BLUETOOTH_SCAN,ACCESS_FINE_LOCATION,INTERNET

# (str) Package name
package.name = resqmesh

# (str) Package domain (needed for android/ios packaging)
package.domain = org.yogesh
